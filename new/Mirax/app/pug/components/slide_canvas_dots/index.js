(function ($) {
let slideCanvas = $("#canvas");

if (slideCanvas.length) {
...
// Popolate particles
    ...
    class Particle {
        constructor(canvas) {
            ...
            this.radius = random > .2 ? Math.random() * 3 : Math.random() * 4;
            this.color = random > .2 ? "#694FB9" : "#9B0127";
            this.radius = random > .8 ? Math.random() * 4.2 : this.radius;
